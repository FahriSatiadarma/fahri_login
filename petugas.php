            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/blank-page.html"> Daftar Baru </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html">Input Gelombang</a></li>
            ...
            <div class="row" id="proBanner">
              <div class="col-12">
                <span class="d-flex align-items-center purchase-popup">
                  <p>Silahkan Tingkatkan Ke Versi Premium Untuk Membuka Fitur Yang Lain.</p>
                  <a href="https://github.com/BootstrapDash/ConnectPlusAdmin-Free-Bootstrap-Admin-Template" target="_blank" class="btn ml-auto download-button">Download Versi Gratis</a>
                  <a href="http://www.bootstrapdash.com/demo/connect-plus/jquery/template/" target="_blank" class="btn purchase-button">Tingkatkan Ke Versi Pro</a>
                  <i class="mdi mdi-close" id="bannerClose"></i>
                </span>
              </div>
            </div>
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Detail Dashboard </h2>
              <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                <div class="btn-group bg-white p-3" role="group" aria-label="Basic example">
                  <button type="button" class="btn btn-link text-light py-0 border-right">Minggu Ini</button>
                  <button type="button" class="btn btn-link text-dark py-0 border-right">Bulan ini</button>
                  <button type="button" class="btn btn-link text-light py-0">6 Bulan</button>
                </div>
                <div class="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
                  <button class="btn bg-white dropdown-toggle p-3 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-calendar mr-1"></i>22 Apr 2024 - 22 Apr 2026</button>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" id="home-tab" data-toggle="tab" href="#" role="tab" aria-selected="true">Pengguna</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business-1" role="tab" aria-selected="false">Bisnis</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="performance-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">Performa</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="conversion-tab" data-toggle="tab" href="#" role="tab" aria-selected="false">Konversi</a>
                    </li>
                  </ul>
                    ...
                    <div class="row">
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="mt-4 mb-0">Diselesaikan</p>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Pengunjung Unik</h5>
                      ...
                      <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Kunjungan</h5>
                          ...
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="d-flex justify-content-between align-items-center mb-4">
                                  <h4 class="card-title mb-0">Aktvitas Terbaru</h4>
                              ...
                              <div class="col-lg-3 col-sm-4 grid-margin  grid-margin-lg-0">
                                ...
                                <div class="text-wrapper d-flex align-items-center justify-content-between mb-2">
                                  ...
                                  <h3 class="mb-0 text-dark font-weight-bold">Rp.92.556.778</h3>
                                ...
                                <div class="wrapper pt-5">
                                  ...
                                  <h3 class="mb-4 text-dark font-weight-bold">Rp.92.556.778</h3>
                              ...
                              <div class="col-lg-9 col-sm-8 grid-margin  grid-margin-lg-0">
                                <div class="pl-0 pl-lg-4 ">
                                  ...
                                  <div class="d-lg-flex align-items-center mb-lg-2 mb-xl-0">
                                      <h3 class="text-dark font-weight-bold mr-2 mb-0">Penjualan</h3>
                                      <h5 class="mb-0">( 49% Peningkatan )</h5>
                                    </div>
                                    <div class="d-lg-flex">
                            ...
                            <div class="row pt-4">
                              <div class="col-sm-6">
                                <div class="text-center border-right border-md-0">
                                  <h4>Konversi</h4>
                                  <h1 class="text-dark font-weight-bold mb-md-3">Rp.3.806.236</h1>
                                </div>
                              </div>
                              <div class="col-sm-6">
                                <div class="text-center">
                                  <h4>Pengembalian</h4>
                                  <h1 class="text-dark font-weight-bold">Rp.1.520.236</h1>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="col-sm-8  grid-margin stretch-card">
                        <div class="card">
                          ...
                          <div class="d-xl-flex justify-content-between mb-2">
                              <h4 class="card-title">Lihat Analisis</h4>

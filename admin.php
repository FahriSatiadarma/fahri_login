...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
                  ...
                  <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                    <div class="row">
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark ">Jumlah Pendaftar</h5>
                            <h1 class="mb-4 text-dark font-weight-bold"><?php echo $row['total_siswa'];?></h1>
                            <p class="mt-4 mb-0"></p>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark ">Jumlah Jurusan</h5>
                            <h1 class="mb-4 text-dark font-weight-bold">5</h1>
                            <p class="mt-4 mb-0"></p>
                            <h3 class="mb-0 font-weight-bold mt-2 text-dark"></h3>
                          </div>
                        </div>
          ...
          <footer class="footer-wrapper">
            ...
            $row = mysqli_fetch_assoc($result);
            $total_pengeluaran = $row['total_pengurangan'];
            $koneksi->close();
            ?>
            
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <div class="col-xl-15 col-lg-10 col-sm-10 grid-margin stretch-card">
            <div class="card">
            <div class="card-body text-center">
            <h5 class="mb-2 text-dark font-family: Helvetica;">Jumlah Pengeluaran</h5>
              <span class="d-block text-center text-sm-left d-sm-inline-block text-dark justify-text-center;" style="font-size : 25px; ">
              RP. <?php echo $row['total_pengurangan'];?></span>
            </div>
                          </div>
                        </div>
            </div>
    ...
    ?> 
            ...
            <h5 class="mb-2 text-dark font-family: Helvetica;">Jumlah Pengeluaran</h5>
              <span class="d-block text-center text-sm-left d-sm-inline-block text-dark justify-text-center;" style="font-size : 25px; ">
              RP.<?php echo number_format($total_income, 0, ',', '.');?></span>
            </div>
                          </div>
                        </div>
            </div>

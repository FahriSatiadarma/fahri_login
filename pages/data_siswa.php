                                ...
                                <form class="needs-validation" action="proses/pros_edit_baru.php" method="post">
                                  <div class="row">
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <input type="text" class="form-control" name="no_pendaftaran" id="firstName" placeholder="" value="<?php echo $row['no_pendaftaran']; ?>" required="" require readonly>
                                    ...
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control" name="tanggal" id="lastName" placeholder="" value="<?php echo $row['tanggal']; ?>" required="" required readonly>
                                    ...
                                    <div class="col-md-6 mb-3">
                                      <label for="lastName">nama_siswa</label>
                                      <input type="text" class="form-control" name="nama_siswa" id="lastName" placeholder="" value="<?php echo $row['nama_siswa']; ?>" required="" require>
                                      <div class="invalid-feedback">
                                        Valid last name is required.
                                      </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control" name="asal_sekolah" id="lastName" placeholder="" value="<?php echo $row['asal_sekolah']; ?>" required="" require>
                                      <div class="invalid-feedback">
                                        Valid last name is required.
                                      </div>
                                    </div>
                                    <div classs="col-md-12 mb-3">
                                        <label fer="cosintry">jurusan</label>
                                        <select class="custon-select d-block w-100"
                                        name="jurusan" id="country" required="">

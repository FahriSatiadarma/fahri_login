...
if (mysqli_query($koneksi, $siswa_query)) {
    ...
    $wali_query = "INSERT INTO data_wali (id, nama_siswa,nama_wali,alamat_wali, pekerjaan_wali,  no_telWali) VALUES ('$last_siswa_id','$namaSiswa', '$namaWali','$alamatWali', '$pekerjaanWali',  '$noTelWali')";
    ...
    header("location:../daftar_baru.php");
} else {
